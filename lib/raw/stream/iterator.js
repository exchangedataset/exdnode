    ...
    async next() {
        if (this.states === null) {
            ...
            for (const [exchange, channels] of Object.entries(this.setting.filter)) {
                const iterator = new exchange_iterator_1.default(this.clientSetting, exchange, channels, this.setting.start, this.setting.end, this.setting.format, this.bufferSize);
