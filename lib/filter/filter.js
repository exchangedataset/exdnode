...
const request_impl_1 = require("./request/request.impl");
...
function filter(clientParams, params) {
    return new request_impl_1.FilterRequestImpl(impl_1.setupSetting(clientParams), request_impl_1.setupSetting(params));
}
exports.filter = filter;
__export(require("./request/request"));
