...
class ShardIterator {
    constructor(clientSetting, filterSetting, bufferSize = variables_1.FILTER_DEFAULT_BUFFER_SIZE) {
        ...
        this.notifier = null;
        this.error = null;
        this.nextDownloadMinute = datetime_1.convertNanosecToMinute(filterSetting.start);
        this.endMinute = datetime_1.convertNanosecToMinute(filterSetting.end);
    ...
    downloadNewShard() {
        ...
        common_1.downloadShard(this.clientSetting, this.filterSetting, this.nextDownloadMinute).then((shard) => {
...
exports.ShardIterator = ShardIterator;
