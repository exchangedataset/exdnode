        ...
        lineStream.on('line', (line) => {
            ...
            switch (prefix) {
                case 'ms':
                    ...
                    lineArr.push({
                        exchange,
                        type: filter_1.LineType.MESSAGE,
 ...
 * @param minute
 */
async function downloadShard(clientSetting, exchange, channels, start, end, minute) {
